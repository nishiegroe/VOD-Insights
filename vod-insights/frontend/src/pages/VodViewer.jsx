...
import MultiVodModal from "../components/MultiVodModal";
...
export default function VodViewer() {
  ...
  const [showMultiVodModal, setShowMultiVodModal] = useState(false);
  ...
  return (
    <section className="vod-viewer-page">
      ...
      <MultiVodModal
        isOpen={showMultiVodModal}
        onClose={() => setShowMultiVodModal(false)}
      />
    </section>
  );
}
