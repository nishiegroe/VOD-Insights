 ...
 * Optimized with memoization to prevent unnecessary re-calculations
 */
export default function GlobalScrubber({
  ...
  // Memoize event marker calculations to prevent recalculation on every render
  // Only recalculate when vods data or globalDuration changes
  ...
  // Memoize percentage calculation (minimal but adds up with frequent renders)
  const currentPercentage = useMemo(
    () => (globalTime / globalDuration) * 100,
