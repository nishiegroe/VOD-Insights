...
export default function BYOVODS() {
    ...
    <section style={{
      ...
      <div style={{textAlign: 'center', alignItems: 'center', display: 'flex', flexDirection: 'column', gap: 32, marginLeft: 48, margin: '48px'}}>
        <h1 style={{ textAlign: 'center', fontSize: '2.3rem', marginBottom: 0, fontWeight: 700, letterSpacing: '0.01em' }}>
          Bring your own VODs. <span style={{color: 'var(--accent)'}}>Analyze <span style={{fontStyle: 'italic'}}>any</span> gameplay</span> footage, no matter the source.
        </h1>
        <span style={{ fontSize: '1.22rem', color: 'var(--muted)', textAlign: 'center', margin: '32px 0', maxWidth: 700 }}>
          Unlike many other existing tools, VOD Insights works with any video file, whether it's from Twitch, YouTube, or your local drive. No matter the source, let our image processing do the heavy lifting to identify key moments and actionable insights.<br/><br/>
          Record with your preferred software, upload to your favorite platform, or keep files locally – VOD Insights is designed to fit seamlessly into your workflow, not the other way around.
        </span>
      </div>
    </section>
  );
